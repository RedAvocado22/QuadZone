...
function NotificationItem({ notification }: { notification: { id: string; type: string; title: string; isUnRead: boolean; description: string; avatarUrl: string | null; postedAt: string | number | null } }) {
...
function renderContent(notification: { type: string; title: string; description: string; avatarUrl: string | null }) {
  const title = (

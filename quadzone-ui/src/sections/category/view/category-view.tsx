...
export function CategoryView() {
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            if (isCategoryPage) {
                ...
                const categoryData = Array.isArray(res.content) ? res.content : [];
                ...
                const totalCount = res.page?.totalElements ?? mapped.length ?? 0;
                setTotal(totalCount);
            } else {
    ...
    const headLabel = isCategoryPage
        ? [{ id: "name", label: "Name" }, { id: "active", label: "Status" }, { id: "" }]
        : [
              { id: "name", label: "Name" },
        ...
        <DashboardContent>
            <Box display="flex" alignItems="center" mb={5}>
                ...
                <Button
                    variant="outlined"
                    color="inherit"
                    startIcon={<Iconify icon={"mdi:swap-horizontal" as any} />}

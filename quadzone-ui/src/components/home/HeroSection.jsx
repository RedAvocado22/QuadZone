...
const HeroSection = () => {
  const [activeTab, setActiveTab] = useState('gaming-monitors');
            ...
            <div className="row align-items-end">
              <div className="col-lg-5">
                <h1 className="font-size-58 text-lh-57 mb-3 font-weight-light">
                  {currentContent.title} <span className="d-block font-size-50">{currentContent.subtitle}</span>
                </h1>
                <div className="mb-6">
                  ...
                  <span className="font-size-55 font-weight-bold text-lh-45">
                    <sup className="font-size-36">$</sup>{currentContent.discount}<sub className="font-size-16">OFF!</sub>
                  </span>
                </div>
                <Link 
                  to="/products" 

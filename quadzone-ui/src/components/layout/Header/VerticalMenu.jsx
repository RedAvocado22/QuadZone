                        ...
                        <nav className="js-mega-menu navbar navbar-expand-xl u-header__navbar u-header__navbar--no-space">
                          <div className="collapse navbar-collapse u-header__navbar-collapse">
                            <ul className="navbar-nav u-header__navbar-nav border-primary border-top-0">
                              ...
                              <li className="nav-item u-header__nav-item">
                                <a href="#" className="nav-link u-header__nav-link font-weight-bold">Computers & Accessories</a>
                              </li>
                              <li className="nav-item u-header__nav-item">
                                <a href="#" className="nav-link u-header__nav-link font-weight-bold">Cameras, Audio & Video</a>
                              </li>
                              <li className="nav-item u-header__nav-item">
                                <a href="#" className="nav-link u-header__nav-link font-weight-bold">Mobiles & Tablets</a>
                              </li>
                              <li className="nav-item u-header__nav-item">
                                <a href="#" className="nav-link u-header__nav-link font-weight-bold">TV & Audio</a>
                              </li>
                              <li className="nav-item u-header__nav-item">
                                <a href="#" className="nav-link u-header__nav-link font-weight-bold">Watches & Eyewear</a>
                              </li>
                            </ul>
                          </div>
                        </nav>
          ...
          <div className="col-md-auto align-self-center">
            <div className="d-flex">
              <ul className="d-flex list-unstyled mb-0">
                <li className="col">
                  <a href="/compare" className="text-gray-90" data-toggle="tooltip" data-placement="top" title="Compare">
                    <i className="font-size-22 ec ec-compare"></i>
                  </a>
                </li>
                <li className="col">
                  <a href="/wishlist" className="text-gray-90" data-toggle="tooltip" data-placement="top" title="Favorites">

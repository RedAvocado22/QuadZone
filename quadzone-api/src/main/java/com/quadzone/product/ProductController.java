...
public class ProductController {
    ...
    @Operation(
            ...
            description = "Retrieve a paginated list of all products in the system with optional search functionality. " +
    ...
    public ResponseEntity<PagedResponse<ProductResponse>> getProducts(
            @Parameter(description = "Page number (0-indexed). Default is 0 for the first page", example = "0")
            @RequestParam(defaultValue = "0") int page,
            @Parameter(description = "Number of products per page. Default is 10, maximum recommended is 100", example = "10")
            @RequestParam(defaultValue = "10") int size,
            @Parameter(description = "Search query to filter products by name, brand, or description. Case-insensitive partial matching", example = "laptop")
    ...
    public ResponseEntity<ProductResponse> getProduct(
            @Parameter(description = "Unique identifier of the product to retrieve", example = "1", required = true)
    ...
    @Operation(
            ...
            description = "Create a new product in the system with all required information. " +
    ...
    @Operation(
            ...
            description = "Update an existing product's information. Supports partial updates - only the fields provided in the request will be modified. " +
    ...
    public ResponseEntity<ProductResponse> updateProduct(
            ...
            @PathVariable Long id,
            @Parameter(description = "Product update request containing fields to modify (all fields optional)", required = true)

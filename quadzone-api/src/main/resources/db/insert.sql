...
VALUES
    ...
    (4, 'Smartphone 6S', 'QuadZone', 'QZ-PH-6S', 'Gold', 'A classic smartphone with a powerful A9 chip.', 699.00, 400.00, 0.14, 80, '/src/assets/img/212X200/img4.jpg', DATE_SUB(NOW(), INTERVAL 5 DAY), true, 2),
